<template>
  <form-wizard @on-complete="onUpdate" title subtitle color="#1B372B" errorColor="#8EC63F">
    <tab-content
      title="Personal information"
      icon="ti-user"
      :before-change="beforeTabSwitchPersonal"
    >
          ...
          <div class="col-md-3 my-1">
            ...
            <div class="input-group mb-1">
              ...
              <v-select
                ...
                :options="formData.relationshipOfficers"
              ></v-select>
            </div>
            <transition name="fade">
              <div
...
<!--               <VueCtkDateTimePicker formatted="YYYY-MM-DD" :noButtonNow="true" :onlyDate="true" inputSize="sm" color="#8EC63E" :right="true" :noHeader="true" :maxDate="this.eighteenYearsAgo.format('YYYY-MM-DD')" format='YYYY-MM-DD' outputFormat='YYYY-MM-DD' v-model="$v.personal.date_of_birth.$model" name="date_of_birth" />-->
          ...
          <!-- guarantor DISABLED 04.05.2023-->
<!--          <div class="col-md-3 my-1">
            <label class="block">Guarantor</label>
            ...
            <div class="input-group mb-1">
              ...
              <v-select
                id="v-select"
                name="guarantor"
                v-model="$v.personal.guarantor.$model"
                :options="formData.guarantors"
              ></v-select>
            </div>
            <transition name="fade">
              <div
                class="text-danger"
                v-show="$v.personal.guarantor.$error && !$v.personal.guarantor.required"
              >* Guarantor is required</div>
            </transition>
          </div>-->
          ...
          <div class="col-md-3 my-1">
            ...
            <div class="input-group mb-1">
              ...
              <v-select
                ...
                :options="formData.prequalifiedAmount"
              ></v-select>
            </div>
            <transition name="fade">
              <div
          ...
          <div class="col-md-3 my-1">
            ...
            <div class="input-group mb-1">
              ...
              <v-select
                ...
                :options="formData.constituencies"
              ></v-select>
            </div>
            <transition name="fade">
              <div
            ...
            <div class="col-md-4 my-1">
              ...
              <div class="input-group mb-1">
                ...
                <v-select
                  ...
                  :options="formData.businessTypes"
                ></v-select>
              </div>
              <transition name="fade">
                <div
...
<!--          </div>-->
    ...
    <button slot="next" class="btn btn-primary">More</button>
    <button slot="finish" :disabled="completed" class="btn btn-primary">Update</button>
...
export default {
  ...
  created() {
    ...
    this.customerProfessionDetails();
  ...
  methods: {
    ...
    /*guarantors: async function() {
      try {
        const response = await axios.get(`${this.rootUrl}registry-data/guarantors`);
        this.formData.guarantors = response.data;
      } catch (err) {
        this.error = err;
      }
    },*/
    ...
    customerProfessionDetails: async function() {
      try {
        const response = await axios.get(
          `${this.rootUrl}registry-data/customer-profession-details/${this.customerId}`
        );
