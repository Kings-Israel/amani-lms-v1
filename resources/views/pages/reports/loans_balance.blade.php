                ...
                <form id="search" class="form-inline row" method="post" action="">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <option value="all" selected>All Credit Officers</option>
                                    @foreach($lfs as $loanOfficer)
                                        <option value="{{$loanOfficer->id}}" >
                                            {{$loanOfficer->name}} - ({{$loanOfficer->branch}} Branch)
                                        </option>
                                    @endforeach
                                </select>
...
@section('js')
    ...
    <script>
        var oTable = $('#cbtn-selectors1').DataTable({
           ...
           // ajax: '{!! route('loans_balance.data') !!}',
           ajax: {
                url: '{!! route('loans_balance.data') !!}',
                data: function (d) {
