                                ...
                                <div id="rolledOver">
                                    ...
                                    <li class="list-group-item justify-content-between mytooltip tooltip-effect-1">
                                        <b class="tooltip-item2" style="color: unset"> Active Pre_interactions:
                                            <span class="tooltip-item2"><i class="icofont icofont-info-circle"></i></span>
                                        </b><span id="pre_interactions"></span>

                                        <span class="mytooltip tooltip-effect-1">
                                        <span class="tooltip-content4 clearfix">
                                         <span class="tooltip-text2">    This shows ACTIVE unattended pre interactions</span>
                                        </span>
                                        </span>
                                    ...
                                    <li class="list-group-item justify-content-between mytooltip tooltip-effect-1">
                                        <b class="tooltip-item2" style="color: unset">Passed Pre_interactions:<span class="tooltip-item2"><i class="icofont icofont-info-circle"></i></span> </b><span
                                    ...
                                    <li class="list-group-item justify-content-between mytooltip tooltip-effect-1">
                                        <b class="tooltip-item2" style="color: unset">Success Rate:<span class="tooltip-item2"><i class="icofont icofont-info-circle"></i></span></b> <span id="success_rate"></span>
                                        <span class="mytooltip tooltip-effect-1">
                                        <span class="tooltip-content4 clearfix">
                                    ...
                                    <li class="list-group-item justify-content-between mytooltip tooltip-effect-1">
                                        <b  class="tooltip-item2" style="color: unset">Monthly Interactions: <span class="tooltip-item2"><i class="icofont icofont-info-circle"></i></span></b><span id="this_month_interactions"></span>
                                        <span class="mytooltip tooltip-effect-1">
                                        <span class="tooltip-content4 clearfix">
                                    ...
                                    <li class="list-group-item justify-content-between mytooltip tooltip-effect-1">
                                        <b class="tooltip-item2" style="color: unset">M Success Rate:<span class="tooltip-item2"><i class="icofont icofont-info-circle"></i></span></b> <span id="monthly_success_rate"></span>
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    ...
                                                    <h4 class="m-b-0">Ksh. <span id="total_paid_interest"></span> / Ksh.
                                                        <span id="total_interest"></span></h4>
                                                </div>
                                                <div class="col col-auto text-right">
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="card-header-right">
                                        <ul class="list-unstyled card-option">
                                            <li>
                                                <a href="{{route('credit_officer_monthly_collection_overview', ['id'=>encrypt($user->id)])}}"
                                                   title="View Customers" class="btn btn-sm btn-primary">View
                                                    Customers</a></li>
                                        </ul>
                                    </div>
                                </div>
    ...
    <script>
        ...
        var oTable = $('#cbtn-selectors1').DataTable({
            ...
            "footerCallback": function (row, data, start, end, display) {
                ...
                $(api.column(8).footer()).html(cust_target / cust_target_data.count());
                $(api.column(9).footer()).html(cust_onboarded);
                $(api.column(10).footer()).html(Math.round((cust_onboarded / customer_target) * 100));


                $(api.column(11).footer()).html(Math.round((Math.floor((actual_dis / dt) * 100 + (AC / CT) * 100 + (cust_onboarded / customer_target) * 100)) / 3));
            },
        });
        ...
        function calls() {
            ...
            $.ajax({
                ...
                cache: false,
                method: "get",
                url: $_base + "ajax_loco_performance/" + '{{$id}}',
                dataType: 'json',
                data: {
                    name: 'customers',
