...
<head>
    <title>{{isset($title) ? $title : 'LMS'}}</title>
    ...
    <meta name="author" content="Mureithi Charles">
...
<div id="pcoded" class="pcoded">
    ...
    <div class="pcoded-container navbar-wrapper">
        @include("pages.check-off.employers.layouts.header")



        <div class="pcoded-main-container">
            <div class="pcoded-wrapper">
                @include("pages.check-off.employers.layouts.sidebar")
...
@include('pages.check-off.employers.layouts.iesupport')


@include('pages.check-off.employers.layouts.scripts')
@yield('js')
</body>
