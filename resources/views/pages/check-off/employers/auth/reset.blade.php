        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form method="POST" action="{{ route('check-off.update_password_confirm') }}" class="md-float-material form-material">
                        @csrf
                            ...
                            <div class="card-block">
                               ...
                               {{-- <div class="form-group form-primary">
                                ...
                                <div class="form-group form-primary row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="email" type="text" class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" name="username" required>
