        ...
        <div class="row">
            <div class="col-md-12 mb-3">
                @if(!auth()->user()->hasRole('accountant'))
                    ...
                    <a href="{{ route('registry.import')}}" class="btn btn-primary">Import Excel</a>
                @endif
            </div>
        </div>
        <div class="card">
            ...
            <div class="card-block">
                <form id="search" class="form-inline row" method="post" action="">
                    ...
                    <div class="col-md-2">
                        <label for="branch">Registration Fee Paid</label>
                        <div class="input-group">
                            <span class="input-group-addon" id="basic-addon1"><i class="icofont icofont-bank-alt"></i></span>
                            <select class="js-example-basic-single form-control{{ $errors->has('registration_fee_paid') ? ' is-invalid' : '' }}" name="registration_fee_paid" required>
                                <option value="all">All</option>
                                <option value="1">Yes</option>
                                <option value="0">No</option>
                            </select>
                        </div>
                        @if ($errors->has('registration_fee_paid'))
                            <span class="text-danger" role="alert">
                                <strong>{{ $errors->first('registration_fee_paid') }}</strong>
                            </span>
                        @endif
                    </div>
                    <div class="col-md-2">
                        <label for="branch">Classification</label>
                        <div class="input-group">
                            <span class="input-group-addon" id="basic-addon1"><i class="icofont icofont-bank-alt"></i></span>
                            <select class="js-example-basic-single form-control{{ $errors->has('classification') ? ' is-invalid' : '' }}" name="classification" required>
                                <option value="all">All</option>
                                <option value="Good">Good</option>
                                <option value="Defaulter">Defaulter</option>
                                <option value="Security Impounded">Security Impounded</option>
                                <option value="Cleared Share">Cleared Share</option>
                            </select>
                        </div>
