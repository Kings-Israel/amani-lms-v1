        ...
        <div class="col-xl-4 col-md-6">
            <div class="card">
                <div class="card-block">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="m-b-5">Total Disbursed Amount</p>
                            <h4 class="m-b-0">Ksh. {{ number_format($disbAmount) }}</h4>
                        </div>
                        <div class="col col-auto text-right">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5>Monthly Disbursement Data - breakdown for {{ $current }}</h5>
                    <span>Graph displaying Loan Disbursements and Total Disbursed Amounts</span>
                ...
                <div class="card-block">
                    @if (!auth()->user()->hasRole('admin') and !auth()->user()->hasRole('accountant'))
                        <div class="col-md-4" style="margin-bottom: 10px">
                            <form method="post" action="{{ route('home.post.disb_filter') }}">
                                @csrf
                    ...
                    @elseif(auth()->user()->hasRole('admin') or auth()->user()->hasRole('accountant'))
                        <form class="form-inline row justify-content-center" method="post"
                            action="{{ route('home.post.disb_filter') }}">
                            @csrf
                            <div class="col-md-3">
                                <label for="'month">Select Month</label>
                        ...
                        data: {
                            ...
                            datasets: [{
                                ...
                                },
                                {
                                    ...
                                    yAxisID: 'B',
                                    data: month_array
                                        .loan_amount // The response got from the ajax request containing data for the completed jobs in the corresponding months
                                }
                            ],
                        },
                        options: {
                            scales: {
                                ...
                                yAxes: [{
                                        ...
                                        ticks: {
                                            min: 0,
                                            max: month_array
                                            .max_disbursement, // The response got from the ajax request containing max limit for y axis
                                            maxTicksLimit: 5
                                        },
                                        gridLines: {
                                            display: false
